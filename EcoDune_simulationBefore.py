...
# Load the dataset
df = pd.read_csv("EcoDune_Scenario_Before.csv")
...
st.markdown("<p style = 'color:#7B6EA3;font-size:18px;'>Display of actual event data before implementing EcoDune 🚀🌱</p>", unsafe_allow_html=True)
